...
def counting(df):
    ...
    mother_obj = {"name":"mother", 
                    "children": [
                        {
                        "name":"analytics",
                        "children": [
                            {
                            "name":"Not Finished Primary",
                            "children":[
                                    {
                                        "name":"Tv",
                                        "size": calculate_sum(count_mother_not_finished_pri[0])
                                    },
                                    {
                                        "name":"Showers",
                                        "size": calculate_sum(count_mother_not_finished_pri[1])
                                    },
                                    {
                                        "name":"Computers",
                                        "size": calculate_sum(count_mother_not_finished_pri[2])
                                    },
                                    {
                                        "name":"Cars",
                                        "size": calculate_sum(count_mother_not_finished_pri[3])
                                    }
                                ]
                                },
                                {
                            ...
                            "children":[
                                    {
                                        "name":"Tv",
                                        "size": calculate_sum(count_mother_primary[0])
                                    },
                                    {
                                        "name":"Showers",
                                        "size": calculate_sum(count_mother_primary[1])
                                    },
                                    {
                                        "name":"Computers",
                                        "size": calculate_sum(count_mother_primary[2])
                                    },
                                    {
                                        "name":"Cars",
                                        "size": calculate_sum(count_mother_primary[3])
                                    }
                                ]
                                },
                            {
                            ...
                            "children":[
                                    {
                                        "name":"Tv",
                                        "size": calculate_sum(count_mother_junior[0])
                                    },
                                    {
                                        "name":"Showers",
                                        "size": calculate_sum(count_mother_junior[1])
                                    },
                                    {
                                        "name":"Computers",
                                        "size": calculate_sum(count_mother_junior[2])
                                    },
                                    {
                                        "name":"Cars",
                                        "size": calculate_sum(count_mother_junior[3])
                                    }
                                ]
                                },                                  
                            {
                            ...
                            "children":[
                                    {
                                        "name":"Tv",
                                        "size": calculate_sum(count_mother_vocational[0])
                                    },
                                    {
                                        "name":"Showers",
                                        "size": calculate_sum(count_mother_vocational[1])
                                    },
                                    {
                                        "name":"Computers",
                                        "size": calculate_sum(count_mother_vocational[2])
                                    },
                                    {
                                        "name":"Cars",
                                        "size": calculate_sum(count_mother_vocational[3])
                                    }
                                ]
                                },                                  
                            {
                            "name":"General_secondary",
                            "children":[
                                    {
                                        "name":"Tv",
                                        "size": calculate_sum(count_mother_secondary[0])
                                    },
                                    {
                                        "name":"Showers",
                                        "size": calculate_sum(count_mother_secondary[1])
                                    },
                                    {
                                        "name":"Computers",
                                        "size": calculate_sum(count_mother_secondary[2])
                                    },
                                    {
                                        "name":"Cars",
                                        "size": calculate_sum(count_mother_secondary[3])
                                    }
                                ]
                                }
                            ]
                    ...
                    "children": [
                    {
                        ...
                        "children": [
                            ...
                            "children":[
                                    {
                                        "name":"Tv",
                                        "size": calculate_sum(count_father_not_finished_pri[0])
                                    },
                                    {
                                        "name":"Showers",
                                        "size": calculate_sum(count_father_not_finished_pri[1])
                                    },
                                    {
                                        "name":"Computers",
                                        "size": calculate_sum(count_father_not_finished_pri[2])
                                    },
                                    {
                                        "name":"Cars",
                                        "size": calculate_sum(count_father_not_finished_pri[3])
                                    }
                                ]
                                },
                                {
                            ...
                            "children":[
                                    {
                                        "name":"Tv",
                                        "size": calculate_sum(count_father_primary[0])
                                    },
                                    {
                                        "name":"Showers",
                                        "size": calculate_sum(count_father_primary[1])
                                    },
                                    {
                                        "name":"Computers",
                                        "size": calculate_sum(count_father_primary[2])
                                    },
                                    {
                                        "name":"Cars",
                                        "size": calculate_sum(count_father_primary[3])
                                    }
                                ]
                                },
                            {
                            ...
                            "children":[
                                    {
                                        "name":"Tv",
                                        "size": calculate_sum(count_father_junior[0])
                                    },
                                    {
                                        "name":"Showers",
                                        "size": calculate_sum(count_father_junior[1])
                                    },
                                    {
                                        "name":"Computers",
                                        "size": calculate_sum(count_father_junior[2])
                                    },
                                    {
                                        "name":"Cars",
                                        "size": calculate_sum(count_father_junior[3])
                                    }
                                ]
                                },                                  
                            {
                            ...
                            "children":[
                                    {
                                        "name":"Tv",
                                        "size": calculate_sum(count_father_vocational[0])
                                    },
                                    {
                                        "name":"Showers",
                                        "size": calculate_sum(count_father_vocational[1])
                                    },
                                    {
                                        "name":"Computers",
                                        "size": calculate_sum(count_father_vocational[2])
                                    },
                                    {
                                        "name":"Cars",
                                        "size": calculate_sum(count_father_vocational[3])
                                    }
                                ]
                                },                                  
                            {
                            ...
                            "children":[
                                    {
                                        "name":"Tv",
                                        "size": calculate_sum(count_father_secondary[0])
                                    },
                                    {
                                        "name":"Showers",
                                        "size": calculate_sum(count_father_secondary[1])
                                    },
                                    {
                                        "name":"Computers",
                                        "size": calculate_sum(count_father_secondary[2])
                                    },
                                    {
                                        "name":"Cars",
                                        "size": calculate_sum(count_father_secondary[3])
                                    }
                                ]
                                }
                                ]
    ...
    return mother_app, father_app, mother_dish, father_dish, mother_books, father_books, mother_obj, father_obj
def calculate_sum(item_list):
    summ = item_list[0] * 0 + item_list[1] * 1 + item_list[2] * 2 + item_list[3] * 3
    return summ
...
if __name__ == "__main__":
    ...
    mother_app, father_app, mother_dish, father_dish, mother_books, father_books, mother_obj, father_obj\
            = counting(df)
    ...
    with io.open("mother.json", 'w') as f:
        f.write(unicode(json.dumps(mother_obj)))
    with io.open("father.json", 'w') as f:
        f.write(unicode(json.dumps(father_obj)))
